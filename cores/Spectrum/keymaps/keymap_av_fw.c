 ...
 * SPDX-FileNotice: Based on https://github.com/zxdos/zxuno/blob/24d87411bb1869d89c7128fe5909c3cabb9603b9/firmware/av.zx7b
 * SPDX-License-Identifier: GPL-3.0-or-later
 */

#define KEYMAP_AV_FW  "av-fw"
#define COMMENT_AV_FW "Spanish (ES) layout for firmware"
#define VERSION_AV_FW "2022-02-04"

#define PC_AV_FW_BACKSLA 0x0E
#define PC_AV_FW_APOSTRO 0x4E
#define PC_AV_FW_OPNBANG 0x55
#define PC_AV_FW_GRAVEAC 0x54
#define PC_AV_FW_PLUS    0x5B
#define PC_AV_FW_EGNE    0x4C
#define PC_AV_FW_ACUTEAC 0x52
#define PC_AV_FW_CEDILLA 0x5D
#define PC_AV_FW_LESS    0x61
#define PC_AV_FW_COMMA   0x41
#define PC_AV_FW_DOT     0x49
#define PC_AV_FW_MINUS   0x4A

void gen_keymap_av_fw() {
  /* Standard keys: */
  ...
  /* Localized keys: */
  map_all(PC_AV_FW_BACKSLA,SP_COLON);
  map_all(PC_AV_FW_APOSTRO,SP_DOLLAR);
  map_all(PC_AV_FW_OPNBANG,SP_EQUAL);
  map_all(PC_AV_FW_GRAVEAC,SP_PAROPEN);
  map_all(PC_AV_FW_PLUS,SP_PARCLOS);
  map_all(PC_AV_FW_EGNE,SP_SEMICOL);
  map_all(PC_AV_FW_ACUTEAC,SP_QUOTE);
  /* Key PC_AV_FW_CEDILLA is not mapped */
  /* Key PC_AV_FW_LESS is not mapped */
  map_all(PC_AV_FW_COMMA,SP_COMMA);
  map_all(PC_AV_FW_DOT,SP_DOT);
  map_all(PC_AV_FW_MINUS,SP_SLASH);
}
