...
Then, pressing `E`, you can access to the other core configuratio options. You can change them with the cursor keys and the `Space` key. Press `Enter` to finish.
