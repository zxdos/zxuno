...
- `F6`: Sets up a custom mark at the current PZX position (only in the version with PZX support)
...
- `F11`: Enabe or disable the Wi-Fi module
- `F12`: Enable or disable 28 MHz CPU speed.
...
- `F2` : Choose ROM 1.22
- `F5`: NMI
- `F10`: Enable audio output when using `CSAVE`
- `Ctrl+Alt+Backspace` or `F11`: Hard reset. Backspace is the delete key, located in the top-right portion of the keyboard, above `Enter`.
