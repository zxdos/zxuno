...
El core necesita para funcionar unos ficheros con las https://es.wikipedia.org/wiki/Imagen_ROM[imagenes ROM] de los chips la maquina arcade original, agregados dentro de un unico fichero .ROM, junto con, al menos, un fichero .ARC que contiene el nombre del fichero ROM a cargar, así como la configuración de los https://es.wikipedia.org/wiki/Interruptor_DIP[interruptores DIP] de la maquina original.

Tanto los ficheros ROM como los ficheros ARC se pueden crear utilizando <<#_mra_tool,MRA Tool>>, tomando como referencia los ficheros MRA disponible en el https://github.com/jotego/jtbin/tree/master/mra[repositorio del creador] del core original.
...
- `Ctrl`, `Alt` y `Espacio` o el mando 1: Botones 1, 2 y 3 del jugador uno
- `Z`, `X`, `C` o el mando 1: Botones 4, 5, 6 del jugador uno
- `R`,`F`,`G`,`D` o mando 2: Movimiento del jugador dos
- `A`, `S` y `Q` o el mando 2: Botones 1, 2 y 3 del jugador dos
- `W`, `I`, `K` o el mando 2: Botones 4, 5, 6 del jugador dos
...
Al pulsar `F12`, se mostrará el menú con las distintas opciones del Core. Se puede navegar utilizando las teclas de cursor o un mando. `Enter` o el botón 2 del mando selecciona un elemento.
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando de lahttps://github.com/jotego/jtdd[versión original de Jotego].
...
El core necesita para funcionar ficheros con las https://es.wikipedia.org/wiki/Imagen_ROM[imagenes ROM] de los chips la maquina arcade original, agregados dentro de un unico fichero .ROM, junto con un fichero .ARC que contiene el nombre del fichero ROM a cargar, así como la configuración de los https://es.wikipedia.org/wiki/Interruptor_DIP[interruptores DIP] de la maquina original.

Tanto los ficheros ROM como los ficheros ARC se pueden crear utilizando <<#_mra_tool,MRA Tool>>, tomando como referencia los ficheros MRA disponible en el https://github.com/jotego/jtbin/blob/master/mra/Double%20Dragon%20(Japan).mra[repositorio del creador] del core original.
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando de la https://github.com/jotego/jtkicker[versión original de Jotego].
...
Tanto los ficheros ROM como los ficheros ARC se pueden crear utilizando <<#_mra_tool,MRA Tool>>, tomando como referencia los ficheros MRA disponible en el https://github.com/jotego/jtbin/blob/master/mra/Kicker.mra[repositorio del creador] del core original.
...
- `Ctrl`, `Alt` y `Espacio` o el mando 1: Botones 1,2 y 3 del jugador
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando de la https://github.com/jotego/jtpang[versión original de Jotego].
...
Tanto los ficheros ROM como los ficheros ARC se pueden crear utilizando <<#_mra_tool,MRA Tool>>, tomando como referencia los ficheros MRA disponible en el https://github.com/jotego/jtbin/blob/master/mra/Pang%20(World).mra[repositorio del creador] del core original.
...
- `F12` mostrar el menú de control del core
- Cursor o el mando 1: Controles de dirección del jugador uno
- `Ctrl`, o el mando 1: Botón 1 del jugador uno
- `I`,`J`,`K`,`L` o mando 2: Movimiento del jugador dos
- `A` o el mando 2: Botón 1 del jugador dos
...
Si se han copiado los ficheros correctos en la tarjeta microSD y se inicia el core, aparecerá una pantalla en blanco. Al pulsar `F12`, se mostrará el menú con las distintas opciones del Core. Se puede navegar utilizando las teclas de cursor o un mando. `Enter` o el botón 2 del mando selecciona un elemento.
