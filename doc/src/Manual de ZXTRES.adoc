...
Asegurarse de que la tarjeta microSD a utilizar está con formato FAT32. De no ser así se puede utilizar https://www.sdcard.org/downloads/formatter/[la herramienta oficial de la SD Association].
...
|[.small]#Amstrad CPC 464#|[.small]#No#|[.small]#No#|[.small]#No#|[.small]#Ninguna#|[.small]#No#|[.small]#No#|[.small]#No utiliza la SD#
|[.small]#Amstrad CPC 6128#|[.small]#Sí#|[.small]#Sí#|[.small]#No#|[.small]#Cualquiera#|[.small]#No#|[.small]#ROMs, Imágenes de disco (`.DSK`)#|[.small]#Necesita ROMs#
|[.small]#Apple IIe#|[.small]#Sí#|[.small]#Sí#|[.small]#No#|[.small]#Cualquiera#|[.small]#No#|[.small]#Imágenes de disco (`.NIB`)#|
|[.small]#Arcade#|[.small]#Sí#|[.small]#Sí#|[.small]#No#|[.small]#Cualquiera#|[.small]#No#|[.small]#Sólo ROMs (`.ARC` y `.ROM`)#|
...
|[.small]#SAM Coupé#|[.small]#Sí#|[.small]#Sí#|[.small]#No#|[.small]#Cualquiera#|[.small]#No#|[.small]#Imágenes de disco (`.MGT`, `.DSK` y `.SAD`)#|
|[.small]#ZX81#|[.small]#Sí#|[.small]#Sí#|[.small]#No#|[.small]#Cualquiera#|[.small]#No#|[.small]#Sólo imágenes (`.O` y `.P`)#|
|[.small]#zx#|[.small]#Sí#|[.small]#Sí#|[.small]#No#|[.small]#Cualquiera#|[.small]#Sí#|[.small]#Completo#|[.small]#Utiliza esxdos interna#
...
- `mbinfo` y `mbupd`: Para obtener información y actualizar el firmware de una <<#_tarjeta_intermedia_middle_board,tarjeta intermedia>> con dos CPUs.
...
- Fichero BIT generado desde una herramienta de síntesis. Normalmente se distribuye con la extensión `.BIT` y se puede cargar en la FPGA con un programador, o desde la  microSD, si se dispone de una <<#_tarjeta_intermedia_middle_board,tarjeta intermedia opcional>> (o Middle Board) usando el <<#_navegador_de_bob_fossil_con_tarjeta_intermedia,plugin BIT>> de esxdos.
...
También es posible actualizar la memoria flash de la FPGA. Por el momento desde el menú de la BIOS sólo es posible utilizar imágenes de 16MiB. Para poder usar una imagen de 32MiB, se ha de usar el comando `UPGRZX3` de <<#_esxdos,esxdos>> y un fichero con el nombre `FLASH_32.ZX3`.
...
Como se ha explicado anteriormente, es posible utilizar otros <<#_cores,cores>> además del de ZX Spectrum por defecto.

[NOTE]
====
Muchos de los cores muestran las entradas de archivos y directorios en el orden de la tabla FAT interna de la tarjeta microSD, y no de manera alfabética. Si se desea ver esta información ordenada, se debe reorganizar la estructura de la tarjeta con una utilidad como FAT Sorter para Windows, https://fatsort.sourceforge.io/[FATsort] para Linux y macOS, https://www.luisrios.eti.br/public/en_us/projects/yafs/[YAFS], http://www.trustfm.net/software/utilities/SDSorter.phpp[SDSorter] u otros.
====
...
Se debe de utilizar una tarjeta microSD, con la primera partición en formato FAT32, para almacenar todos los ficheros necesarios. Para el funcionamiento correcto del core se ha de copiar a la raíz de la tarjeta microSD, al menos, el fichero `832OSDAD.BIN` disponible en el https://github.com/zxtres/cores/tree/main/minimig[repositorio de cores de ZXTRES], junto con un fichero ROM de https://es.wikipedia.org/wiki/Kickstart[Kickstart] de Amiga, con el nombre `KICK.ROM`.
...
Si no estuviera ya, <<#_cores,instalar o ejecutar el core de Amiga (minimig)>> en el ZXTRES.
...
El https://es.wikipedia.org/wiki/Amstrad_CPC_6128[Amstrad CPC 6128] fue el ordenador sucesor del CPC 464. Como novedad, aparte de tener más memoria RAM, incorporaba unidad de disco.

La https://github.com/ZXMicroJack/amstrad-cpc[versión para ZXTRES] ha sido desarrollada por MicroJack, partiendo de la versión para ZX-Uno del core de Amstrad CPC 464, creada por McLeod.
...
Además son necesarios los ficheros ROM siguientes que se pueden obtener http://www.cpcwiki.eu/index.php/FPGAmstrad#How_to_assemble_it[en la wiki oficial] de otro proyecto más antiguo o en su https://github.com/renaudhelias/FPGAmstrad/raw/master/OS6128_BASIC1-1_AMSDOS_MAXAM.zip[repositorio de GitHub]:
...
[.text-center]
image:img/cpc6128.png[scaledwidth=50%]
...
La familia de computadores https://es.wikipedia.org/wiki/Apple_II[Apple II] fue la primera serie de microcomputadoras de producción masiva hecha por la empresa Apple Computer entre 1977 y mediados de los años 1980. 

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/gyurco/apple2efpga[versión original de gyurco].
...
[TIP]
====
Se puede convertir ficheros de imágenes DO ó DSK en NIB con la utilidad https://github.com/slotek/dsk2nib[dsk2nib] para Linux o macOS. También hay una versión disponible para Windows en el https://github.com/zxdos/zxuno/tree/master/cores/Apple2/roms[repositorio original de ZX-Uno].
====
...
[.text-center]
image:img/apple2e.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/1942[versión original de Jotego].
...
Tanto los ficheros ROM como los ficheros ARC se pueden crear utilizando <<#_mra_tool,MRA Tool>>, tomando como referencia los ficheros MRA disponibles en el https://github.com/jotego/jtbin/tree/master/mra[repositorio del creador] del core original.

[TIP]
====
La utilidad https://github.com/kounch/ARC_ROM_Builder#castellano[ARC and ROM Builder] permite construir la estructura de archivos ARC y ROM adecuada para usar con los cores de Jotego, descargando todo lo necesario desde internet.
====
...
[.text-center]
image:img/jt1942.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/1943[versión original de Jotego].
...
[.text-center]
image:img/jt1943.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/aliens[versión original de Jotego].
...
[.text-center]
image:img/jtaliens.png[scaledwidth=50%]
...
La máquina recreativa de https://es.wikipedia.org/wiki/Tetris[Tetris], licenciada y distribuida por Atari, en 1988.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/MrX-8B/MiSTer-Arcade-AtariTetris[versión original para MiSTer].
...
Tanto los ficheros ROM como los ficheros ARC se pueden crear utilizando <<#_mra_tool,MRA Tool>>, tomando como referencia los ficheros MRA disponibles en el https://github.com/MiSTer-devel/Arcade-ATetris_MiSTer[repositorio] del core original.
...
[.text-center]
image:img/ataritetris.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/ninja[versión original de Jotego].
...
El core necesita para funcionar unos ficheros con las https://es.wikipedia.org/wiki/Imagen_ROM[imágenes ROM] de los chips de la máquina recreativa original, agregados dentro de un unico fichero .ROM, junto con, al menos, un fichero .ARC que contiene el nombre del fichero ROM a cargar, así como la configuración de los https://es.wikipedia.org/wiki/Interruptor_DIP[interruptores DIP] de la maquina original.
...
[.text-center]
image:img/jtninja.png[scaledwidth=50%]
...
https://es.wikipedia.org/wiki/Bionic_Commando_(arcade)[Bionic Commmando] es un videojuego de plataformas de acción de 1987 lanzado por Capcom para máquinas recreativas.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/biocom[versión original de Jotego].
...
[.text-center]
image:img/jtbiocom.png[scaledwidth=50%]
...
https://es.wikipedia.org/wiki/Black_Tiger_(videojuego)[Black Tiger] es un videojuego de plataformas creado en 1987 por la compañía japonesa Capcom, y que originalmente fue lanzado para máquina recreatia.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/btiger[versión original de Jotego].
...
[.text-center]
image:img/jtbtiger.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/bubl[versión original de Jotego].
...
[.text-center]
image:img/jtbubl.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcps[versión original de Jotego].
...
[.text-center]
image:img/jtcps1.jpg[scaledwidth=50%]
...
Capcom Play System 1.5 o https://en.wikipedia.org/wiki/CP_System#CP_System_Dash[CP System Dash] es una revisión mejorada de CPS-1.
...
[.text-center]
image:img/jtcps15.jpg[scaledwidth=50%]
...
[.text-center]
image:img/jtcps2.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/comsc[versión original de Jotego].
...
[.text-center]
image:img/jtcomsc.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/commnd[versión original de Jotego].
...
[.text-center]
image:img/jtcommnd.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/contra[versión original de Jotego].
...
[.text-center]
image:img/jtcontra.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/dd[versión original de Jotego].
...
Tanto los ficheros ROM como los ficheros ARC se pueden crear utilizando <<#_mra_tool,MRA Tool>>, tomando como referencia los ficheros MRA disponibles en el repositorio del creador] del core original.
...
[.text-center]
image:img/jtdd.jpg[scaledwidth=50%]
...
Double Dragon 2 es un https://es.wikipedia.org/wiki/Double_Dragon_II:_The_Revenge[videojuego lanzado para máquinas recreativas] en 1988 por Technōs Japan y es la primera secuela de Double Dragon.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/dd2[versión original de Jotego].
...
[.text-center]
image:img/jtdd2.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/exed[versión original de Jotego].
...
[.text-center]
image:img/jtexed.png[scaledwidth=50%]
...
https://en.wikipedia.org/wiki/F-1_Dream[F-1 Dream] es un juego de carreras de coches lanzado por Capcom en 1988 para máquinas recreativas

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/da2e1098c271ff003fd0635214d829acb8f49892/cores/f1drm[versión original de Jotego].
...
[.text-center]
image:img/jtf1drm.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/gng[versión original de Jotego].
...
[.text-center]
image:img/jtgng.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/gunsmk[versión original de Jotego].
...
[.text-center]
image:img/jtgunsmk.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/castle[versión original de Jotego].
...
[.text-center]
image:img/jtcastle.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/sarms[versión original de Jotego].
...
[.text-center]
image:img/jtsarms.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/kchamp[versión original de Jotego].
...
[.text-center]
image:img/jtkchamp.png[scaledwidth=50%]
...
Kicker (o Shao-lin's Road) es un https://en.wikipedia.org/wiki/Shao-lin's_Road[videojuego lanzado para máquinas recreativas] en 1985, por Konami.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/kicker[versión original de Jotego].
...
[.text-center]
image:img/jtkicker.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/midres[versión original de Jotego].
...
[.text-center]
image:img/jtmidres.png[scaledwidth=50%]
...
https://en.wikipedia.org/wiki/Mikie[Mikie] es un videojuego de máquina recreatia desarrollado y lanzado por Konami en 1984.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/mikie[versión original de Jotego].
...
[.text-center]
image:img/jtmikie.png[scaledwidth=50%]
...
https://es.wikipedia.org/wiki/Flak_Attack[MX 5000], conocido en Japón como Flak Attack, es un videojuego de matamarcianos con scroll vertical de Konami publicado originalmente como máquina recreativa en agosto de 1987. 

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/mx5k[versión original de Jotego].
...
[.text-center]
image:img/jtmx5k.png[scaledwidth=50%]
...
https://es.wikipedia.org/wiki/The_New_Zealand_Story[The New Zealand Story] es un videojuego desarrollado por la compañía Taito Corporation lanzado, originalmente como arcade, en 1988.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/kiwi[versión original de Jotego].
...
[.text-center]
image:img/jtkiwi.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/outrun[versión original de Jotego].
...
[.text-center]
image:img/jtoutrun.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/pang[versión original de Jotego].
...
Tanto los ficheros ROM como los ficheros ARC se pueden crear utilizando <<#_mra_tool,MRA Tool>>, tomando como referencia los ficheros MRA disponibles en el https://github.com/jotego/jtbin/blob/master/mra/Pang%20(World).mra[repositorio del creador] del core original.
...
[.text-center]
image:img/jtpang.jpg[scaledwidth=50%]
...
https://en.wikipedia.org/wiki/Konami's_Ping_Pong[Konami's Ping Pong] es un juego de deportes de máquina recreativa creado por Konami en 1985.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/pinpon[versión original de Jotego].
...
[.text-center]
image:img/jtpinpon.png[scaledwidth=50%]
...
https://en.wikipedia.org/wiki/Pirate_Ship_Higemaru[Pirate Ship Higemaru] es un videojuego de Capcom lanzado originalmente en 1984 como máquina recreativa.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/71d789a487e1b72ca4ee12a76d2a51a2cdc61414/cores/hige[versión original de Jotego].
...
[.text-center]
image:img/jthige.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/rastan[versión original de Jotego].
...
[.text-center]
image:img/jtrastan.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/kunio[versión original de Jotego].
...
[.text-center]
image:img/jtkunio.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/roadf[versión original de Jotego].
...
[.text-center]
image:img/jtroadf.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/cop[versión original de Jotego].
...
[.text-center]
image:img/jtcop.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/roc[versión original de Jotego].
...
[.text-center]
image:img/jtroc.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/s16[versión original de Jotego].
...
[.text-center]
image:img/jts16.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/s16b[versión original de Jotego].
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/sectnz[versión original de Jotego].
...
[.text-center]
image:img/jtsectnz.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/slyspy[versión original de Jotego].
...
[.text-center]
image:img/jtslyspy.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/rumble[versión original de Jotego].
...
[.text-center]
image:img/jtrumble.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/shanon[versión original de Jotego].
...
[.text-center]
image:img/jtshanon.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/tora[versión original de Jotego].
...
[.text-center]
image:img/jttora.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/labrun[versión original de Jotego].
...
[.text-center]
image:img/jtlabrun.png[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/trojan[versión original de Jotego].
...
[.text-center]
image:img/jttrojan.jpg[scaledwidth=50%]
...
La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/master/cores/vigil[versión original de Jotego].
...
[.text-center]
image:img/jtvigil.png[scaledwidth=50%]
...
https://es.wikipedia.org/wiki/Vulgus[Vulgus] es un videojuego de desplazamiento vertical desarrollado y publicado por Capcom en Japón en 1984 para máquinas recreativas.

La versión para ZXTRES ha sido desarrollada por somhic, adaptando la https://github.com/jotego/jtcores/tree/f35e0e19c67566c5defd8699a8dafafddf60ae30/cores/vulgus[versión original de Jotego].
...
[.text-center]
image:img/jtvulgus.png[scaledwidth=50%]
...
Si no estuviera ya, <<#_cores,instalar o ejecutar el core de Atari 2600>> en el ZXTRES.
...
[WARNING]
====
Al menos hasta la versión 20230702, este core no funciona correctamente usando el <<#_navegador_de_bob_fossil_con_tarjeta_intermedia,plugin BIT>>, y se ha de cargar desde SPI flash, bien directamente, bien con el <<#_navegador_de_bob_fossil,plugin ZX3>>.
====
...
El https://github.com/zxtres/jupiter_ace[core para ZXTRES] ha sido desarrollado por McLeod, partiendo de la https://zxuno.com/forum/viewtopic.php?f=40&t=75&p=539[versión original para ZX-Uno], principalmente como un ejemplo documentado de cómo portar cores a ZXTRES.
...
Si no estuviera ya, <<#_cores,instalar o ejecutar el core de Jupiter ACE>> en el ZXTRES.
...
Se puede copiar, si se desea, un fichero `ZX8X.ROM` (disponible en el https://github.com/avlixa/ZX81_MiSTer_zxdos/raw/master/roms/zx8x.rom[repositorio oficial]) en el directorio `/zx81/roms`: se trata de los ficheros ZX81 rom (8k) + ZX80 rom (4k) concatenados.
...
Si no estuviera ya, <<#_cores,instalar o ejecutar el core zx>> en el ZXTRES.
...
[.text-center]
image:img/zx.png[scaledwidth=70%]
...
[WARNING]
====
Al menos hasta la versión 20230922, este core no funciona correctamente usando el <<#_navegador_de_bob_fossil_con_tarjeta_intermedia,plugin BIT>>, y se ha de cargar desde SPI flash, bien directamente, bien con el <<#_navegador_de_bob_fossil,plugin ZX3>>.
====
...
Si no estuviera ya, <<#_cores,instalar o ejecutar el core de ZX Spectrum Next>> en el ZXTRES.
...
[.text-center]
image:img/mbjoy1.png[scaledwidth=60%]
...
[.text-center]
image:img/mbjoy2.png[scaledwidth=60%]
...
[.text-center]
image:img/mbjoy3.png[scaledwidth=60%]
...
[.text-center]
image:img/mbjoy4.png[scaledwidth=60%]
...
- `BIN/MBUPD` - <<#_comandos_de_esxdos,Comando "DOT">> de actualización de firmware
- `BIN/MBINFO` - <<#_comandos_de_esxdos,Comando "DOT">> que muestra información sobre el firmware de la Middle Board
- `BIN/BPLUGINS/BIT` - Versión más reciente del <<#_navegador_de_bob_fossil_con_tarjeta_intermedia,plugin BIT>> para esxdos
- p2s.uf2 - Actualización de firmware para middle board con sólo una CPU.
...
[.text-center]
image:img/mbinfo.png[scaledwidth=70%]
...
[.text-center]
image:img/mbupd1.png[scaledwidth=70%]

[start=3]
. Pulsar cualquier tecla para realizar la actualización.

[.text-center]
image:img/mbupd2.png[scaledwidth=70%]
...
[TIP]
====
En la sección de <<#_jtag,referencias>> hay información para poder usar otros programadores JTAG distintos de USB-Blaster.
====
...
. Instalar https://openocd.org[Open On-Chip Debugger (OpenOCD)] o bien https://trabucayre.github.io/openFPGALoader/guide/install.html[openFPGALoader] en el sistema usando el gestor de paquetes correspondiente.
...
Para OpenOCD en macOS (usando https://brew.sh[Homebrew]):
...
Para openFPGALoader en macOS (usando https://brew.sh[Homebrew]):
...
[start=3]
. Conectar el USB-Blaster al ordenador, y los cables correspondientes al ZXTRES <<#_preparación_del_cableado_jtag,tal y como se explica anteriormente>>. Si ya estuviera conectado, desconectar y volver a conectar para asegurarse de que se activan las reglas de udev.
...
[start=5]
. Copiar en la Raspberry Pi el fichero `recovery.bit` obtenido anteriormente del https://github.com/zxtres/cores/tree/main/recovery[repositorio principal de Github]. En nuestro ejemplo, se dejará en `/home/pi/zxtres/unbrick/`
...
- FPGA: https://www.xilinx.com/products/silicon-devices/fpga/artix-7.html#productTable[Xilinx Artix] A35T (ZXTRES), A100T (ZXTRES+) y A200T (ZXTRES++).
- Memoria: 2MB de https://es.wikipedia.org/wiki/SRAM[SRAM] (todos los modelos) y 32MB (ZXTRES) o 64MB (ZXTRES+, ZXTRES++) de https://es.wikipedia.org/wiki/SDRAM[SDRAM].
- Almacenamiento: https://es.wikipedia.org/wiki/Serial_Peripheral_Interface[SPI] https://es.wikipedia.org/wiki/Memoria_flash[Flash] de 32MB. Lector de https://es.wikipedia.org/wiki/MicroSD[tarjetas MicroSDHC]
- Vídeo: https://es.wikipedia.org/wiki/Conversor_de_señal_digital_a_analógica[DAC] RGB (https://es.wikipedia.org/wiki/Color_verdadero[(truecolor - 24-bit]). Salida digital DisplayPort y DE-15 (VGA y RGB)
...
- 1 entrada USB A: Para conectar teclados (en los modelos con <<#_tarjeta_intermedia_middle_board,Tarjeta intermedia>> instalada).
...
Existen varios proyectos que permiten modificar la EEPROM de placas USB con chips FTDI con capacidad para hablar protocolo JTAG, de forma que se comporten como clones de un https://digilent.com/shop/fpga-boards/programmers/[cable programador JTAG] oficial, de forma más económica.

Los chips soportados son https://www.ftdichip.com/old2020/Products/ICs/FT2232H.html[FT2232H] y https://www.ftdichip.com/old2020/Products/ICs/FT232H.htm[FT232H].
...
Descargar el https://github.com/vanbwodonk/ft2232hl-jtag-clone/tree/main/eeprom_binary[nuevo firmware desde GitHub].
...
Para el uso con OpenOCD, descargar el fichero de configuración del https://github.com/zxtres/wiki/blob/main/Files/OpenOCD_0.10.0-11/FT2232H_FT232H.cfg[repositorio de GitHub de ZXTRES], al directorio de trabajo (en los ejemplos, `/home/zxtres/unbrick` o `/Users/zxtres/unbrick` para macOS).
...
[.text-center]
image:img/ft232zxtres.png[scaledwidth=60%]
...
Los comandos a utilizar son los mismos que se indican en las <<#_recuperación_del_firmware, instrucciones de recuperación>>, pero usando referencias a FT2232H, FT232H en vez de `usb-blaster`
...
https://github.com/ZXMicroJack/amstrad-cpc[Core Amstrad CPC 6128]]
...
https://github.com/erd0spy/ft232h_to_digilent_fpga_programmer[Cracking FT232H to make Digilent JTAG Programmer]

https://github.com/vanbwodonk/ft2232hl-jtag-clone/tree/main[FT2232HL-jtag-clone]

https://gist.github.com/rikka0w0/24b58b54473227502fa0334bbe75c3c1[FT2232 to Digilent JTag for Xilinx FPGAs (ISE/Vivado)]
