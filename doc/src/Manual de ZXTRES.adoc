...
[TIP]
====
Para construir ficheros .neo desde ficeros ROM originales, existen múltiples herramientas para convertir desde https://github.com/city41/neosdconv[formato MAME] o https://gitlab.com/loic.petit/darksoft-to-neosd/[formato Darksoft].
====
