...
[CAUTION]
====
The VGA frequency affects the master clock frequency. For communication between the core and the Wi-Fi module to work correctly, the frequency must be set to 50 Hz (see the <<#_advanced,BIOS settings chapter>>).
====
